...
pub use commands::{
    ...
    DuplicateProfilePayload, ExitApplicationPayload, ImportProfilePayload, NativeCommandHost,
    PrimarySimIdPayload, ProcessConfirmationPayload, ProfileIdPayload, QuitPayload,
    RestartApplicationPayload, SaveProfilePayload, UpdateSettingsPayload, accept_recovery,
    approve_profile, cancel_process_action, cancel_startup, close_session, confirm_process_action,
    create_profile, delete_profile, discover_applications, dismiss_recovery, duplicate_profile,
    exit_application, export_diagnostics, export_profile, get_app_snapshot, import_profile,
...
pub use contracts::{
    ...
    ProcessConfirmationAction, ProcessConfirmationSnapshot, ProcessIdentity, ProcessOutput,
    ProcessOwnership, ProcessStatus, ProfileApplication, ProfileReviewStatus, ProfileSummary,
    QuitAction, QuitDisposition, RacingProfile, SessionApplicationRole, SessionApplicationSnapshot,
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::confirm_process_action,
            commands::cancel_process_action,
